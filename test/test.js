...
describe('FirePath.contains', function () {
  ...
  it('should work for case insensitive system', function () {
    FirePath.contains('c:\\foo\\bar', 'C:\\Foo\\Bar')
    .should.eql(process.platform === 'win32', 'c:\\foo\\bar === C:\\Foo\\Bar in Windows');
  });
});
